...
from agbs.engine.backward import BackwardInterpreter, BiasBackwardSemantics
    ...
    def state(self):
        ...
        if self.domain == AbstractDomain.BOXES1:
            ...
            precursory = ProductState(self.inputs, [
                Symbolic3State(self.inputs),
                DeepPolyStateA(self.inputs),
                DeepPolyStateB(self.inputs),
                NeurifyState(self.inputs)
            ])
